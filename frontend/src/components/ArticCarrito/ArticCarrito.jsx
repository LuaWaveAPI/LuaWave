...
return(
    <>
        ...
        <button className={style.bold} onClick={()=>operation(articuloscantidad - 1)}>-</button>
        <button className={style.bold} onClick={()=>operation(0)}><img className={style.papelera} src="https://raw.githubusercontent.com/LuaWaveAPI/LuaWave/main/frontend/src/img/logoEliminar.png" alt="Eliminar"></img></button>
    </>
)
}
